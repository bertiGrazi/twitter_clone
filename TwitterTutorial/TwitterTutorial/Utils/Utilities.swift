...
class Utilities {
    ...
    func attributedButton(_ firstPart: String, _ secondPart: String) -> UIButton {
        ...
        attributedTitle.append(NSMutableAttributedString(string: secondPart, attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 16), NSMutableAttributedString.Key.foregroundColor: UIColor.white]))
